        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Course2Teacher | Admin Panel</h2>
                </div>
                    ...
                    <form method="POST" action="api.php">
                                        ...
                                        <div class="rs-select2 js-select-simple select--no-search">
                                            <select name="teacher" required="">
                                                ...
                                                <?php
                                                    ...
                                                    $stmt->execute();
                                                    while($stmt->fetch()){?>
                                                        <option name="teacher" value="<?php echo $n; ?>"><?php echo $n; ?></option>
                                                    <?php
                                                    }
                                                ?>
                                            </select>
                        ...
                        <div class="form-row">
                                        ...
                                        <div class="rs-select2 js-select-simple select--no-search">
                                            <select name="course" required="">
                                                ...
                                                <?php
                                                    ...
                                                    $stmt->execute();
                                                    while($stmt->fetch()){?>
                                                        <option name="course" value="<?php echo $n; ?>"><?php echo $n; ?></option>
                                                    <?php
                                                    }
                                                ?>
                                            </select>
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="semester" required="">
                                    </div>
                                </div>
                            </div>
                        <div>
                            <button class="btn btn--radius-2 btn--red" type="submit" name="acsub">Assign Course</button>
                            </span>
                        </div>
                    </form>
                </div>
