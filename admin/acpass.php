        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    ...
                    <button style="float: right; margin-right: 2%; margin-top: 1%; border-radius: 4px;" class="button btn--red"><a href="apanel.php" style="color: white;">Go Back</a></button>
                <div class="card-body">
                    <form method="POST" action="api.php">
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" type="submit" name="cpass">Save</button>
                        </div>
                    </form>
                </div>
            </div>
