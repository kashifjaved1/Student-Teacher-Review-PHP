    ...
    <div class="page-wrapper p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <center>
                        <button class="btnMod btn--red"><a href="atfun.php" style="color: white;">Teacher Functions</a></button>&nbsp;&nbsp;
                        <button class="btnMod btn--radius-2 btn--red"><a href="acfun.php" style="color: white;">Course Functions</a></button><br>
                        <button class="btnMod btn--radius-2 btn--red"><a href="mtt.php" style="color: white;">Write Message</a></button>&nbsp;&nbsp;
                        <button class="btnMod btn--radius-2 btn--red"><a href="rvgraf.php" style="color: white;">View Review</a></button><br>
