...
<head>
    ...
    <!-- Title Page-->
    <title>Teacher Review Graph</title>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Review Graph</h2>
                </div>
                    <button style="float: right; margin-right: 2%; margin-top: 1%; border-radius: 4px;" class="button btn--red"><a href="javascript:history.go(-2);" id="ltc" style="color: white;">Go Back</a></button>
                <div class="card-body">
