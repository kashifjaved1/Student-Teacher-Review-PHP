                        ...
                        <form method="POST" action="api.php">
                            ...
                            <div class="name">Teacher</div>
                                <div class="value">
                                    ...
                                    <input class="input--style-5" type="text" name="tname" required="" value="<?php echo $_SESSION['tn']; ?>" disabled="disabled" style="cursor: not-allowed;">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                    ...
                                    <div class="input-group">
                                        <div class="rs-select2 js-select-simple select--no-search">
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT `cname`, `forsem` FROM `ctt` WHERE `tname` = ?";
                                                $stmt=$con->prepare($sql);
                                                $stmt->bind_param("s",$_SESSION['tn']);
                                                $stmt->bind_result($cn, $s);
                                                $stmt->execute();
                                                while($stmt->fetch()){?>
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <div class="rs-select2 js-select-simple select--no-search">
                                            ...
                                            <?php
                                                $con=mysqli_connect("localhost", "root", "","wt");
                                                $sql = "SELECT `tname` FROM `ctt` WHERE 1";
                                                $stmt=$con->prepare($sql);
                                                $stmt->bind_result($n);
                                                $stmt->execute();
                                                while($stmt->fetch()){?>
